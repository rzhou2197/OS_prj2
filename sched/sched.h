...
struct task_group {
	...
	struct wrr_bandwidth wrr_bandwidth;
#endif
...
{
	return sysctl_sched_wrr_runtime >= 0;
}
...
/* Prj2-WRR */
extern struct wrr_bandwidth def_wrr_bandwidth;
extern void init_wrr_bandwidth(struct wrr_bandwidth *wrr_b, u64 period, u64 runtime);
